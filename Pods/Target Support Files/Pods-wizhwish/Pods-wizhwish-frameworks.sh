...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/AeroGear-Push-Swift/AeroGearPush.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/PBJVideoPlayer/PBJVideoPlayer.framework"

...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/ACEDrawingView/ACEDraggableText.bundle"
  install_resource "FormatterKit/FormatterKit/FormatterKit.bundle"
  install_resource "../Submodules/kickflip-ios-sdk/Kickflip/Resources/KFCameraReverse@2x.png"
  install_resource "../Submodules/kickflip-ios-sdk/Kickflip/Resources/KFCameraReversePressed@2x.png"
  install_resource "../Submodules/kickflip-ios-sdk/Kickflip/Resources/KFDeviceRotation@2x.png"
  install_resource "../Submodules/kickflip-ios-sdk/Kickflip/Resources/KFRecordButtonBorder@2x.png"
  install_resource "../Submodules/kickflip-ios-sdk/Kickflip/Resources/KFRecordButtonStart@2x.png"
  install_resource "../Submodules/kickflip-ios-sdk/Kickflip/Resources/KFRecordButtonStop@2x.png"
  install_resource "../Submodules/kickflip-ios-sdk/Kickflip/Resources/KFStreamTableViewCellDots@2x.png"

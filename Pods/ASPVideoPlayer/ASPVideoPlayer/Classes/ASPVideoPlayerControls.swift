...
@IBDesignable open class ASPVideoPlayerControls: ASPBasicControls {
	...
	*/
	...
	//	perform(#selector(setter: isInteracting), with: false, afterDelay: 0.0)
       // isInteracting = false
        perform(#selector(updateInteraction), with: false , afterDelay: 0.1)
       
	}
    
    @objc private func updateInteraction() {

  ...
  //  NSBundle *assetsBundle = [NSBundle bundleWithURL:[containerBundle URLForResource:@"CSNotificationView" withExtension:@"bundle"]];
    ...
    switch (style) {
        case CSNotificationViewStyleSuccess:
            ...
            //[UIImage imageWithContentsOfFile:[assetsBundle pathForResource:@"checkmark" ofType:@"png"]];
            break;
        case CSNotificationViewStyleError:
            matchedImage = [UIImage imageNamed:@"exclamationMark.png"];
            
            //[UIImage imageWithContentsOfFile:[assetsBundle pathForResource:@"exclamationMark" ofType:@"png"]];
            break;
        default:
            break;
    }
